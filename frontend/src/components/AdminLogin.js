  ...
  return (
    <div className="patient-auth-bg">
      <div style={{ textAlign: "center", position: "relative", width: "100%", maxWidth: "400px", margin: "0 auto", padding: "40px", background: "white", borderRadius: "12px", boxShadow: "0 4px 15px rgba(0,0,0,0.1)" }}>
        ...
        <h2 style={{ color: "#2c3e50", marginBottom: "30px" }}>Admin Access</h2>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "15px" }}>
            ...
            <button 
                onClick={handleLogin}
                style={{ padding: "12px", background: "#c0392b", color: "white", border: "none", borderRadius: "6px", cursor: "pointer", fontSize: "16px", fontWeight: "bold" }}
            >
            Login as Admin
            </button>
        </div>
